...
<body style="color: rgb(255,255,255);">
    <nav class="navbar navbar-light navbar-expand bg-light navigation-clean"
        ...
        <div class="container">
            <a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#"
                ...
                <div class="sidebar-brand-text mx-3" style="font-size: 16px;line-height: 24px;letter-spacing: 0.8;">
                    <span
                        style="font-size: 21px;font-family: Nunito, sans-serif;letter-spacing: 0.8px;line-height: 21px;color: rgb(255,255,255);">RR.HH.</span>
                </div>
            </a><a href="#"
                style="padding: 0px;width: 673px;font-size: 20px;color: rgb(217,217,217);font-family: 'Source Sans Pro', sans-serif;height: 34px;padding-right: px;margin-left: 8px;margin-top: 8px;">Postulantes</a><button
                class="navbar-toggler" data-toggle="collapse"></button>
            <div>
                <a href="#" class="pulseBtn">Iniciar Sesión</a>
            </div>
        </div>
    </nav>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-9 mx-auto">
                    <h1 class="mb-5">Gestiona, Automatiza, Administra y Moderniza el manejo de RR.HH. de tu Empresa</h1>
                </div>
                <div class="col-md-10 col-lg-8 col-xl-7 mx-auto">
                    <form>
                        <div class="form-row">
                            <div class="col-12 col-md-9 mb-2 mb-md-0"><input class="form-control" type="text"
                                    placeholder="Enter your email..."></div>
                            <div class="col-12 col-md-3"><button class="btn btn-primary btn-block btn-lg"
                                    type="submit">Comenzar!</button></div>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <section class="features-icons bg-light text-center"
        style="background: linear-gradient(135deg, #172a74, #21a9af), #184e8e;">
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                ...
                <div class="col-lg-4" style="color: rgb(174,184,220);">
                    <div class="mx-auto features-icons-item mb-5 mb-lg-0 mb-lg-3" style="color: rgb(255,255,255);">
        ...
        <div class="container-fluid p-0">
            <div class="row no-gutters">
                ...
                <div class="col-lg-6 my-auto order-lg-1 showcase-text"
                    style="background: linear-gradient(135deg, #172a74, #21a9af), #184e8e;width: 602px;height: 485px;">
            ...
            <div class="row no-gutters">
                ...
                <div class="col-lg-6 my-auto order-lg-1 showcase-text"
                    style="background: linear-gradient(135deg, #172a74, #21a9af), #184e8e;height: 484px;">
            ...
            <div class="row no-gutters">
                ...
                <div class="col-lg-6 my-auto order-lg-1 showcase-text"
                    style="background: linear-gradient(135deg, #172a74, #21a9af), #184e8e;height: 483px;">
    ...
    <section class="call-to-action text-white text-center"
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-9 mx-auto">
                    <h2 class="mb-4">¿Esta Listo ahora? ¡Comencemos!</h2>
                </div>
                <div class="col-md-10 col-lg-8 col-xl-7 mx-auto">
                    <form>
                        <div class="form-row">
