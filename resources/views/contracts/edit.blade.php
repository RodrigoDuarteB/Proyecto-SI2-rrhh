...
<div class="container-fluid">
    ...
    <div class="card shadow mb-3">
        <div class="card-header py-3">
            <p class="text-primary m-0 font-weight-bold">Editar Contrato</p>
        </div>
        <div class="card-body">
            <div class="form-row">
                <div class="col">
                ...
                <div class="col">
                    <div class="form-group"><label><strong>ID Empleado:</strong><br></label><input type="text"
                            name="id_employee" value="id" style="margin-left: 25px;" disabled=""></div>
                </div>
            </div>
            <div class="form-row">
                <div class="col">
                    <div class="form-group"><label><strong>Fecha Inicio :</strong><br></label><input type="date"
                            name="date_start" style="margin-left: 20px;" disabled=""></div>
