...
@section('content')
    ...
    <div class="x_panel mt-5">
        ...
        <h3 class="text-dark mt-3">Editar Cargo</h3>
        <div class="row mt-3">
            <div class="col-md-9 col-sm-6 float-center" style="padding-top: 0px;margin-top: 0px;margin-bottom: 0px;">
                <div class="card shadow mb-3">
                    <div class="card-header py-3">
                        <p class="text-primary m-0 font-weight-bold">Datos del Cargo</p>
                    </div>
                    <div class="card-body">
                        <form id="form-solicitud" data-parsley-validate class="form-horizontal form-label-left" action="{{route('jobs.update', [$job->id]) }}"
                            ...
                            <div class="col">
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <input type="text" id="name" name="name"  value="{{$job->name}}" required="required" class="form-control">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <input type="text" id="description" name="description" value="{{$job->description}}" required="required"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <input type="number" id="base_salary" name="base_salary" value="{{$job->base_salary}}" required="required"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <select name="department_id" id="department_id" class="form-control" 
                                        onchange="carg2(this);">
                                        <option value="{{$job->department->id}}">{{$job->department->name}}</option>
