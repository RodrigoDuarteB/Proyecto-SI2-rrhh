...
<link rel="stylesheet" href="{{ asset('assets/css/Vertical-Mobile-Collapsible-Menu.css') }}">
<link rel="stylesheet" href="{{ asset('assets/css/Login-Form-blue-Gradient-1.css') }}">
