@extends('layouts.app')
    @section('content')
        ...
        <div class="container table-responsive table-bordered table table-hover table-bordered results">
            <a class="btn btn-primary mb-3 ml-2 mt-2" type="button" href="{{ route('roles.create') }}">Nuevo Rol</a>
            @if(count($roles) >= 1)
                <div class="card" style="font-size: 20px">
                    <div class="card-body" style="font-weight: bold">
                        <table class="table table-bordered table-hover text-center" id="roles">
