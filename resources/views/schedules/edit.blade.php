...
<div class="x_panel mt-5"> 
    ...
    <h3 class="text-dark mt-3">Editar Horario</h3>
    <div class="row mt-3">
        <div class="col-md-9 col-sm-6 float-center" style="padding-top: 0px;margin-top: 0px;margin-bottom: 0px;">
            <div class="card shadow mb-3">
                <div class="card-header py-3">
                    <p class="text-primary m-0 font-weight-bold">Datos del  Horario</p>
                </div>
                <div class="card-body">
                    <form id="form-solicitud" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="{{route('schedules.update', [$schedule->id]) }}"
                        action="/schedules">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="col">
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="name" name="name"  value="{{$schedule->name}}" required="required" class="form-control">
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="time" id="clock_in" name="clock_in" value="{{$schedule->clock_in}}" required="required" class="form-control">
                                </div>
                            </div>
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align"
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="time" id="clock_out" name="clock_out" value="{{$schedule->clock_out}}" required="required" class="form-control">
                                </div>
                            </div>
